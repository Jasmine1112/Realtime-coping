...
import com.example.jasmine.realtimecoping2.bitalino.util.*;



public class Main2 extends RoboActivity{
    private static final String TAG = "MainActivity";
    private static final boolean UPLOAD = false;
    public static BITalinoFrame[] frames;
    */
/*
    ...
    private class TestAsyncTask extends AsyncTask<Void, String, Void> {
        ...
        protected Void doInBackground(Void... paramses) {
            try {
                ...
                final String remoteDevice = "98:D3:31:20:55:33";
...
/*
     ...
     *//*
                ...
                bitalino = new BITalinoDevice(1000, new int[]{0});
